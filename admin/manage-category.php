...
<div class="main-content"> 
    <div class="wrapper">
        ...
        <a href="<?php echo HOME;?>admin/add-category.php" class="btn-primary">Add category </a> </br></br>
...
<table class="tbl-full">
        ...
        <?php 
                ...
                //create sr. no. and assign val 1
                $sn=1;

                //check whether we have data is database or not
                if($count>0)
                {
                        //we have data in database, get data and display
                ...
                {
                        //when we do not have data display msg inside table
                        ?>
                <tr>
